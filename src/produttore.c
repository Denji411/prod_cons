...
void* produttore(void*) {
    ...
    /*
        Domanda 3.1: Alla prima iterazione, mutex_prod è libero e di conseguenza non si blocca.
            Questo perché dev'essere il primo ad operare, fornendo un dato da dare al consumatore.

        Domanda 3.2: Dopo pthread_mutex_unlock(&mutex_cons), il produttore non può immediatamente rientrare nel ciclo e riscrivere dato.
